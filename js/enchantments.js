 ...
 *   - weight: Anvil cost multiplier (used as: level * weight)
...
const ENCHANTMENT_DB = [
  ...
  { id: "sharpness", name: "Sharpness", maxLevel: 5, weight: 1,
    items: ["sword", "axe"], exclusiveWith: ["smite", "bane_of_arthropods", "cleaving"] },
  { id: "smite", name: "Smite", maxLevel: 5, weight: 1,
    items: ["sword", "axe"], exclusiveWith: ["sharpness", "bane_of_arthropods", "cleaving"] },
  { id: "bane_of_arthropods", name: "Bane of Arthropods", maxLevel: 5, weight: 1,
    items: ["sword", "axe"], exclusiveWith: ["sharpness", "smite", "cleaving"] },
  { id: "cleaving", name: "Cleaving", maxLevel: 3, weight: 1,
    items: ["axe"], exclusiveWith: ["sharpness", "smite", "bane_of_arthropods"] },
  { id: "knockback", name: "Knockback", maxLevel: 2, weight: 1,
    items: ["sword"], exclusiveWith: [] },
  { id: "fire_aspect", name: "Fire Aspect", maxLevel: 2, weight: 2,
    items: ["sword"], exclusiveWith: [] },
  { id: "looting", name: "Looting", maxLevel: 3, weight: 2,
    items: ["sword"], exclusiveWith: [] },
  { id: "sweeping_edge", name: "Sweeping Edge", maxLevel: 3, weight: 2,
    items: ["sword"], exclusiveWith: [] },

  // === Ranged Weapon Enchantments ===
  { id: "power", name: "Power", maxLevel: 5, weight: 1,
    items: ["bow"], exclusiveWith: [] },
  { id: "punch", name: "Punch", maxLevel: 2, weight: 2,
    items: ["bow"], exclusiveWith: [] },
  { id: "flame", name: "Flame", maxLevel: 1, weight: 2,
    items: ["bow"], exclusiveWith: [] },
  { id: "infinity", name: "Infinity", maxLevel: 1, weight: 4,
    items: ["bow"], exclusiveWith: ["mending"] },
  { id: "multishot", name: "Multishot", maxLevel: 1, weight: 2,
    items: ["crossbow"], exclusiveWith: ["piercing"] },
  { id: "quick_charge", name: "Quick Charge", maxLevel: 3, weight: 1,
    items: ["crossbow"], exclusiveWith: [] },
  { id: "piercing", name: "Piercing", maxLevel: 4, weight: 1,
    items: ["crossbow"], exclusiveWith: ["multishot"] },
  { id: "loyalty", name: "Loyalty", maxLevel: 3, weight: 1,
    items: ["trident"], exclusiveWith: ["riptide"] },
  { id: "impaling", name: "Impaling", maxLevel: 5, weight: 2,
    items: ["trident"], exclusiveWith: [] },
  { id: "riptide", name: "Riptide", maxLevel: 3, weight: 2,
    items: ["trident"], exclusiveWith: ["loyalty", "channeling"] },
  { id: "channeling", name: "Channeling", maxLevel: 1, weight: 4,
    items: ["trident"], exclusiveWith: ["riptide"] },

  // === Tool Enchantments ===
  { id: "efficiency", name: "Efficiency", maxLevel: 5, weight: 1,
    items: ["pickaxe", "shovel", "axe", "hoe", "shears"], exclusiveWith: [] },
  { id: "silk_touch", name: "Silk Touch", maxLevel: 1, weight: 4,
    items: ["pickaxe", "shovel", "axe", "hoe"], exclusiveWith: ["fortune"] },
  { id: "fortune", name: "Fortune", maxLevel: 3, weight: 2,
    items: ["pickaxe", "shovel", "axe", "hoe"], exclusiveWith: ["silk_touch"] },
  { id: "luck_of_the_sea", name: "Luck of the Sea", maxLevel: 3, weight: 2,
    items: ["fishing_rod"], exclusiveWith: [] },
  { id: "lure", name: "Lure", maxLevel: 3, weight: 2,
    items: ["fishing_rod"], exclusiveWith: [] },

  // === Armor Enchantments ===
  { id: "protection", name: "Protection", maxLevel: 4, weight: 1,
    items: ["helmet", "chestplate", "leggings", "boots"], exclusiveWith: ["blast_protection", "fire_protection", "projectile_protection"] },
  { id: "fire_protection", name: "Fire Protection", maxLevel: 4, weight: 1,
    items: ["helmet", "chestplate", "leggings", "boots"], exclusiveWith: ["protection", "blast_protection", "projectile_protection"] },
  { id: "blast_protection", name: "Blast Protection", maxLevel: 4, weight: 2,
    items: ["helmet", "chestplate", "leggings", "boots"], exclusiveWith: ["protection", "fire_protection", "projectile_protection"] },
  { id: "projectile_protection", name: "Projectile Protection", maxLevel: 4, weight: 1,
    items: ["helmet", "chestplate", "leggings", "boots"], exclusiveWith: ["protection", "fire_protection", "blast_protection"] },
  { id: "thorns", name: "Thorns", maxLevel: 3, weight: 4,
    items: ["helmet", "chestplate", "leggings", "boots"], exclusiveWith: [] },
  { id: "respiration", name: "Respiration", maxLevel: 3, weight: 2,
    items: ["helmet"], exclusiveWith: [] },
  { id: "aqua_affinity", name: "Aqua Affinity", maxLevel: 1, weight: 2,
    items: ["helmet"], exclusiveWith: [] },
  { id: "feather_falling", name: "Feather Falling", maxLevel: 4, weight: 1,
    items: ["boots"], exclusiveWith: [] },
  { id: "depth_strider", name: "Depth Strider", maxLevel: 3, weight: 2,
    items: ["boots"], exclusiveWith: ["frost_walker"] },
  { id: "frost_walker", name: "Frost Walker", maxLevel: 2, weight: 2,
    items: ["boots"], exclusiveWith: ["depth_strider"] },
  { id: "soul_speed", name: "Soul Speed", maxLevel: 3, weight: 4,
    items: ["boots"], exclusiveWith: [] },
  { id: "swift_sneak", name: "Swift Sneak", maxLevel: 3, weight: 4,
    items: ["leggings"], exclusiveWith: [] },

  // === Universal Enchantments ===
  { id: "unbreaking", name: "Unbreaking", maxLevel: 3, weight: 1,
